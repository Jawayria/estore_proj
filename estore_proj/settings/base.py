...
from estore_proj.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('ESTORE_PROJ_SECRET_KEY', 'insecure-secret-key')
...
PROJECT_APPS = (
    'estore_proj.apps.core',
    'estore_proj.apps.api',
)
...
ROOT_URLCONF = 'estore_proj.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'estore_proj.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'estore_proj.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'estore_proj_sessionid'
CSRF_COOKIE_NAME = 'estore_proj_csrftoken'
LANGUAGE_COOKIE_NAME = 'estore_proj_language'
