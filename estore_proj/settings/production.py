...
from estore_proj.settings.base import *
from estore_proj.settings.utils import get_env_setting
...
# This may be overridden by the YAML in estore_proj_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

CONFIG_FILE = get_env_setting('ESTORE_PROJ_CFG')
