...
"""
Estore documentation build configuration file.
...
VERSION = get_version('../estore_proj', '__init__.py')
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An estore for a brand',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'estore_proj'),
                os.path.join(root_path, 'estore_proj/migrations')])
